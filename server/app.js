...
db.once('open', async () => {
  ...
  const products = await Product.insertMany([
    ...
    },
    {
      ...
      image: 'https://www.etsy.com/listing/719326254/orbit-loop-earrings-chainIt seems that the code snippet was cut off in the middle of the last line. Please provide the remaining part of the code, and Ill be happy to assist you further.',
